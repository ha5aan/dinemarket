...
<div className='flex bg-[#d6d6d8] flex-col justify-center content-start  lg:flex-row  lg:justify-around  mx-4  my-2'>
...
<div className=' bg-[#212121] pt-12 px-11 pb-8  mx-4  my-2 text-center'>
...
<button className='text-sm font-[700] w-fit m-auto  rounded-lg bg-[#474747] py-1 px-10 mt-[5px] text-[#fff] text-center tracking-[.25em]'>
DINEWEEKENDSALE
</button>
...
<div className='bg-[#efe1c7] mx-4 text-center lg:text-left my-2'>
    ...
    <div className='flex justify-center lg:content-end'>
...
<div className='bg-[#d7d7d9] mx-4 text-center lg:text-left my-2'>
